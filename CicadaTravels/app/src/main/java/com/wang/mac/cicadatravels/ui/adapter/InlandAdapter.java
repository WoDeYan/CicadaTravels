...
public class InlandAdapter extends BaseAdapter {
    ...
    public void setBeanArrayList(ArrayList<SearchBean.ChinaDestinationsBean> beanArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.inlandTv.setText(beanArrayList.get(position).getName());
        return convertView;
    }
    class  ViewHolder {
        private TextView inlandTv;
        public ViewHolder(View view) {
            inlandTv = (TextView) view.findViewById(R.id.foreign_tv);
        }
    }
}
