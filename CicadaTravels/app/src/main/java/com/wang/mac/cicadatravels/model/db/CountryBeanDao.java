    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COUNTRY_BEAN\" (" + //
                ...
                "\"COUNTRY_NAME\" TEXT);"); // 1: countryName
    }
    ...
    public CountryBean readEntity(Cursor cursor, int offset) {
        CountryBean entity = new CountryBean( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // countryName
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, CountryBean entity, int offset) {
        ...
        entity.setCountryName(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(CountryBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
